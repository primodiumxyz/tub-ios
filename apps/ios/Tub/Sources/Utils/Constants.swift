...
private let serverUrlHost: String = {
    let src = installationSource
    if src == .appStore || src == .testFlight {
...
public let FILTERING_MIN_TRADES: Numeric = 3  // minimum amount of trades during the filtering interval to be included
public let FILTERING_MIN_VOLUME_USD: Numeric = 0  // minimum volume during the filtering interval to be included
