...
public class AddTokenSaleMutation: GraphQLMutation {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation AddTokenSale($token_mint: String!, $token_amount: numeric!, $token_price_usd: numeric!, $token_decimals: Int!, $user_wallet: String!, $user_agent: String!, $source: String, $error_details: String, $build: String) { insert_token_sale_one( object: { token_mint: $token_mint token_amount: $token_amount token_price_usd: $token_price_usd token_decimals: $token_decimals user_wallet: $user_wallet user_agent: $user_agent source: $source error_details: $error_details build: $build } ) { __typename id } }"#
    ))
  ...
  public struct Data: TubAPI.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("insert_token_sale_one", Insert_token_sale_one?.self, arguments: ["object": [
