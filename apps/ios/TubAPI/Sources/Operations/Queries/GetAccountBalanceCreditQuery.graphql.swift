...
public class GetAccountBalanceCreditQuery: GraphQLQuery {
  public static let operationName: String = "GetAccountBalanceCredit"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query GetAccountBalanceCredit($accountId: uuid!) { account_transaction_aggregate( where: { account: { _eq: $accountId }, transaction_type: { _eq: "credit" } } ) { __typename aggregate { __typename sum { __typename amount } } } }"#
    ))
