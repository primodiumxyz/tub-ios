...
public class GetAccountBalanceDebitQuery: GraphQLQuery {
  public static let operationName: String = "GetAccountBalanceDebit"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query GetAccountBalanceDebit($accountId: uuid!) { account_transaction_aggregate( where: { account: { _eq: $accountId }, transaction_type: { _eq: "debit" } } ) { __typename aggregate { __typename sum { __typename amount } } } }"#
    ))
