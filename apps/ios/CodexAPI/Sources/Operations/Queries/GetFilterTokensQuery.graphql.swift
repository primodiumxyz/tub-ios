...
public class GetFilterTokensQuery: GraphQLQuery {
  ...
  public init(
    rankingAttribute: GraphQLNullable<GraphQLEnum<TokenRankingAttribute>> = .init(.trendingScore1),
  ...
  public struct Data: CodexAPI.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("filterTokens", FilterTokens?.self, arguments: [
        "filters": [
