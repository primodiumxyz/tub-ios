...
import { SplToken22 } from "@/lib/programs/spl-token-22.program";
import { SplToken } from "@/lib/programs/spl-token.program";
import {
  emitLayout,
  metadataLayout,
  removeKeyLayout,
...
} from "@/lib/programs/token-extensions";

import { getAccountDataSizeLayout } from "../programs/token-extensions/get-account-data-size-extension";
  ...
  switch (ixType) {
    ...
    case "Allocate": {
      ...
      parsed = {
        ...
        args: { space: BigInt(decoded.space) },
        // @ts-expect-error: type difference @coral-xyz/anchor -> @project-serum/anchor
      } as unknown as ParsedIdlInstruction<SystemProgramIdl, "allocate">;
      break;
    }
    case "AllocateWithSeed": {
      ...
      parsed = {
        ...
        args: {
          seed: decoded.seed,
          space: BigInt(decoded.space),
          owner: decoded.programId,
          base: decoded.basePubkey,
        },
        // @ts-expect-error: type difference @coral-xyz/anchor -> @project-serum/anchor
      } as unknown as ParsedIdlInstruction<SystemProgramIdl, "allocateWithSeed">;
      break;
    }
    case "Assign": {
      ...
      parsed = {
        ...
        // @ts-expect-error: type difference @coral-xyz/anchor -> @project-serum/anchor
      } as unknown as ParsedIdlInstruction<SystemProgramIdl, "assign">;
      break;
    }
    case "AssignWithSeed": {
    ...
    case "AuthorizeNonceAccount": {
      ...
      parsed = {
        ...
        // @ts-expect-error: type difference @coral-xyz/anchor -> @project-serum/anchor
      } as unknown as ParsedIdlInstruction<SystemProgramIdl, "authorizeNonceAccount">;
      break;
    }
    case "Create": {
      ...
      parsed = {
        ...
        args: { lamports: BigInt(decoded.lamports), owner: decoded.programId, space: BigInt(decoded.space) },
        // @ts-expect-error: type difference @coral-xyz/anchor -> @project-serum/anchor
      } as unknown as ParsedIdlInstruction<SystemProgramIdl, "createAccount">;
      break;
    }
    case "CreateWithSeed": {
      ...
      parsed = {
        ...
        args: {
          lamports: BigInt(decoded.lamports),
          owner: decoded.programId,
          space: BigInt(decoded.space),
          seed: decoded.seed,
          base: decoded.basePubkey,
        ...
        // @ts-expect-error: type difference @coral-xyz/anchor -> @project-serum/anchor
      } as unknown as ParsedIdlInstruction<SystemProgramIdl, "createAccountWithSeed">;
      break;
    }
    ...
    case "Transfer": {
      ...
      parsed = {
        ...
        args: { lamports: BigInt(decoded.lamports.toString()) },
        // @ts-expect-error: type difference @coral-xyz/anchor -> @project-serum/anchor
      } as unknown as ParsedIdlInstruction<SystemProgramIdl, "transfer">;
      break;
    }
    case "TransferWithSeed": {
      ...
      parsed = {
        ...
        args: { owner: decoded.programId, lamports: BigInt(decoded.lamports.toString()), seed: decoded.seed },
        // @ts-expect-error: type difference @coral-xyz/anchor -> @project-serum/anchor
      } as unknown as ParsedIdlInstruction<SystemProgramIdl, "transferWithSeed">;
      break;
    }
    case "WithdrawNonceAccount": {
      ...
      parsed = {
        ...
        args: { lamports: BigInt(decoded.lamports) },
        // @ts-expect-error: type difference @coral-xyz/anchor -> @project-serum/anchor
      } as unknown as ParsedIdlInstruction<SystemProgramIdl, "withdrawNonceAccount">;
      break;
    }
    default: {
      parsed = null;
  ...
  switch (decoded) {
    ...
    case spl.TokenInstruction.InitializeMultisig: {
      ...
      parsed = {
        ...
        accounts: [
          { name: "multisig", ...decodedIx.keys.account },
          { name: "rentSysvar", ...decodedIx.keys.rent },
          ...multisig,
        ],
    ...
    case spl.TokenInstruction.Transfer: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()) },
      } as unknown as ParsedIdlInstruction<SplToken, "transfer">;
      break;
    }
    case spl.TokenInstruction.Approve: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()) },
      } as unknown as ParsedIdlInstruction<SplToken, "approve">;
      break;
    }
    ...
    case spl.TokenInstruction.SetAuthority: {
      ...
      parsed = {
        ...
        accounts: [
          ...
          { name: "currentAuthority", ...decodedIx.keys.currentAuthority },
          ...multisig,
        ],
    ...
    case spl.TokenInstruction.MintTo: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()) },
      } as unknown as ParsedIdlInstruction<SplToken, "mintTo">;
      break;
    }
    case spl.TokenInstruction.Burn: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()) },
      } as unknown as ParsedIdlInstruction<SplToken, "burn">;
      break;
    }
    ...
    case spl.TokenInstruction.TransferChecked: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()), decimals: decodedIx.data.decimals },
      } as unknown as ParsedIdlInstruction<SplToken, "transferChecked">;
      break;
    }
    case spl.TokenInstruction.ApproveChecked: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()), decimals: decodedIx.data.decimals },
      } as unknown as ParsedIdlInstruction<SplToken, "approveChecked">;
      break;
    }
    case spl.TokenInstruction.MintToChecked: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()), decimals: decodedIx.data.decimals },
      } as unknown as ParsedIdlInstruction<SplToken, "mintToChecked">;
      break;
    }
    case spl.TokenInstruction.BurnChecked: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()), decimals: decodedIx.data.decimals },
      } as unknown as ParsedIdlInstruction<SplToken, "burnChecked">;
      break;
    }
    case spl.TokenInstruction.InitializeAccount2: {
      ...
      const initializeAccount2InstructionData = struct<InitializeAccount2InstructionData>([
        u8("instruction"),
        blob(32, "owner"),
      ]);
    ...
    case spl.TokenInstruction.InitializeAccount3: {
      ...
      const initializeAccount3InstructionData = struct<InitializeAccount3InstructionData>([
        u8("instruction"),
        blob(32, "owner"),
      ]);
  ...
  switch (decoded) {
    ...
    case spl.TokenInstruction.Transfer: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()) },
      } as unknown as ParsedIdlInstruction<SplToken22, "transfer">;
      break;
    }
    case spl.TokenInstruction.Approve: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()) },
      } as unknown as ParsedIdlInstruction<SplToken22, "approve">;
      break;
    }
    case spl.TokenInstruction.Revoke: {
    ...
    case spl.TokenInstruction.MintTo: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()) },
      } as unknown as ParsedIdlInstruction<SplToken22, "mintTo">;
      break;
    }
    case spl.TokenInstruction.Burn: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()) },
      } as unknown as ParsedIdlInstruction<SplToken22, "burn">;
      break;
    }
    case spl.TokenInstruction.CloseAccount: {
    ...
    case spl.TokenInstruction.TransferChecked: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()), decimals: decodedIx.data.decimals },
      } as unknown as ParsedIdlInstruction<SplToken22, "transferChecked">;
      break;
    }
    case spl.TokenInstruction.ApproveChecked: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()), decimals: decodedIx.data.decimals },
      } as unknown as ParsedIdlInstruction<SplToken22, "approveChecked">;
      break;
    }
    case spl.TokenInstruction.MintToChecked: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()), decimals: decodedIx.data.decimals },
      } as unknown as ParsedIdlInstruction<SplToken22, "mintToChecked">;
      break;
    }
    case spl.TokenInstruction.BurnChecked: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()), decimals: decodedIx.data.decimals },
      } as unknown as ParsedIdlInstruction<SplToken22, "burnChecked">;
      break;
    }
    case spl.TokenInstruction.InitializeAccount2: {
      interface InitializeAccount2InstructionData {
    ...
    case spl.TokenInstruction.AmountToUiAmount: {
      ...
      parsed = {
        ...
        args: { amount: BigInt(decodedIx.data.amount.toString()) },
      } as unknown as ParsedIdlInstruction<SplToken22, "amountToUiAmount">;
      break;
    }
    ...
    case spl.TokenInstruction.TransferFeeExtension: {
      ...
      switch (discriminator) {
        ...
        case spl.TransferFeeInstruction.WithdrawWithheldTokensFromAccounts: {
          const decodedIx = spl.decodeWithdrawWithheldTokensFromAccountsInstruction(
            instruction,
        ...
        case spl.TransferFeeInstruction.SetTransferFee: {
          const decodedIx = spl.decodeSetTransferFeeInstruction(instruction, spl.TOKEN_2022_PROGRAM_ID);
          const tokenMint = decodedIx.keys.mint;
      ...
      switch (discriminator) {
        ...
        case spl.DefaultAccountStateInstruction.Update: {
          ...
          parsed = {
            ...
            accounts: [
              { name: "mint", ...instruction.keys[0] },
              { name: "freezeAuthority", ...instruction.keys[1] },
              { ...multisig },
            ],
            args: { accountState: spl.AccountState[instructionData.accountState] },
          } as unknown as ParsedIdlInstruction<any>;
      ...
      switch (discriminator) {
        case spl.TransferHookInstruction.Initialize: {
          ...
          parsed = {
            ...
            accounts: [{ name: "mint", ...instruction.keys[0] }],
            args: {
              authority: instructionData.authority,
              transferHookProgramId: instructionData.transferHookProgramId,
            },
          } as unknown as ParsedIdlInstruction<any>;
          break;
        }
...
): ParsedInstruction<AssociatedTokenProgramIdlLike> {
  return {
