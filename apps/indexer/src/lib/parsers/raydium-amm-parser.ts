...
const DepositArgsLayout = struct<DepositArgs>([u64("maxCoinAmount"), u64("maxPcAmount"), u64("baseSide")]);
...
const AdminCancelOrdersArgsLayout = struct<AdminCancelOrdersArgs>([u16("limit")]);
