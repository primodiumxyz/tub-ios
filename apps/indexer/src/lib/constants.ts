...
import { RaydiumClammParser } from "./parsers/raydium-clamm";

export const PRICE_DATA_BATCH_SIZE = 300;
export const PRICE_PRECISION = 10 ** 18;

export const PLATFORMS = ["meteora-dlmm", "orca-whirlpool", "raydium-lp-v4", "raydium-clamm"] as const;
...
export const RAYDIUM_CLAMM_PUBLIC_KEY = RaydiumClammParser.PROGRAM_ID;
